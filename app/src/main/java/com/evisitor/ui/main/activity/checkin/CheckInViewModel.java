...
public class CheckInViewModel extends BaseCheckInOutViewModel<ActivityNavigator> {
    ...
    List<VisitorProfileBean> getCommercialGuestProfileBean(CommercialVisitorResponse.CommercialGuest guests) {
        ...
        if (getDataManager().isIdentifyFeature()) {
            visitorProfileBeanList.add(new VisitorProfileBean(getNavigator().getContext().getString(R.string.data_identity_type, guests.getDocumentType().isEmpty() ? getNavigator().getContext().getString(R.string.na) : guests.getDocumentType())));
    ...
    List<VisitorProfileBean> getCommercialStaffBean(CommercialStaffResponse.ContentBean bean) {
        ...
        visitorProfileBeanList.add(new VisitorProfileBean(getNavigator().getContext().getString(R.string.data_staff_id, bean.getEmployeeId().isEmpty() ? getNavigator().getContext().getString(R.string.na) : bean.getEmployeeId())));
        ...
        visitorProfileBeanList.add(new VisitorProfileBean(getNavigator().getContext().getString(R.string.data_identity_type, bean.getDocumentType().isEmpty() ? getNavigator().getContext().getString(R.string.na) : bean.getDocumentType())));
    ...
    List<VisitorProfileBean> getHouseKeepingProfileBean(HouseKeeping houseKeeping) {
        ...
        visitorProfileBeanList.add(new VisitorProfileBean(getNavigator().getContext().getString(R.string.data_identity_type, houseKeeping.getDocumentType().isEmpty() ? getNavigator().getContext().getString(R.string.na) : houseKeeping.getDocumentType())));
    ...
    List<VisitorProfileBean> getServiceProviderProfileBean(ServiceProvider serviceProvider) {
        ...
        visitorProfileBeanList.add(new VisitorProfileBean(getNavigator().getContext().getString(R.string.data_identity_type, serviceProvider.getDocumentType().isEmpty() ? getNavigator().getContext().getString(R.string.na) : serviceProvider.getDocumentType())));
