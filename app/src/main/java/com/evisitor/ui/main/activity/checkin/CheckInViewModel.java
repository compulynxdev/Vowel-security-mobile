...
public class CheckInViewModel extends BaseViewModel<GuestNavigator> {
    ...
    List<VisitorProfileBean> getGuestCheckInProfileBean(Guests guests) {
        ...
        visitorProfileBeanList.add(new VisitorProfileBean(getNavigator().getContext().getString(R.string.data_time, guests.getCheckInTime())));
    ...
    List<VisitorProfileBean> getHouseKeepingCheckInProfileBean(HouseKeeping houseKeeping) {
        ...
        visitorProfileBeanList.add(new VisitorProfileBean(getNavigator().getContext().getString(R.string.data_time, houseKeeping.getCheckInTime())));
        ...
        visitorProfileBeanList.add(new VisitorProfileBean(getNavigator().getContext().getString(R.string.data_host, houseKeeping.getHost())));
        getNavigator().hideLoading();
        return visitorProfileBeanList;
    }
    ...
    List<VisitorProfileBean> getServiceProviderCheckInProfileBean(ServiceProvider serviceProvider) {
        ...
        visitorProfileBeanList.add(new VisitorProfileBean(getNavigator().getContext().getString(R.string.data_time, serviceProvider.getCheckInTime())));
        ...
        visitorProfileBeanList.add(new VisitorProfileBean(getNavigator().getContext().getString(R.string.data_host, serviceProvider.getHost())));
        getNavigator().hideLoading();
        return visitorProfileBeanList;
    }
