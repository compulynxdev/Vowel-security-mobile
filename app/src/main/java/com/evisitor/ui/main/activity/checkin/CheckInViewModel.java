...
public class CheckInViewModel extends BaseCheckInOutViewModel<ActivityNavigator> {
    ...
    List<VisitorProfileBean> getHouseKeepingCheckInProfileBean(HouseKeeping houseKeeping) {
        ...
        //visitorProfileBeanList.add(new VisitorProfileBean(getNavigator().getContext().getString(R.string.data_comp_name, houseKeeping.getCo().isEmpty() ? getNavigator().getContext().getString(R.string.na) : houseKeeping.getCom())));
