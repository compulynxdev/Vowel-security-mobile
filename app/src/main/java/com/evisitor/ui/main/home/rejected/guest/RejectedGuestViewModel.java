...
public class RejectedGuestViewModel extends BaseViewModel<RejectedGuestNavigator> {
    ...
    List<VisitorProfileBean> getVisitorDetail(Guests guests) {
        ...
        visitorProfileBeanList.add(new VisitorProfileBean(getNavigator().getContext().getString(R.string.vehicle_col),guests.getExpectedVehicleNo().isEmpty() ? getNavigator().getContext().getString(R.string.na) : guests.getExpectedVehicleNo(), VisitorProfileBean.VIEW_TYPE_ITEM));
