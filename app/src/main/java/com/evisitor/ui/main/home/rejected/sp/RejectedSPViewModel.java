...
public class RejectedSPViewModel extends BaseViewModel<RejectedSPNavigator> {
    ...
    List<VisitorProfileBean> getVisitorDetail(ServiceProvider spBean) {
        ...
        visitorProfileBeanList.add(new VisitorProfileBean(getNavigator().getContext().getString(R.string.data_identity_type, spBean.getDocumentType().isEmpty() ? getNavigator().getContext().getString(R.string.na) : spBean.getDocumentType())));
